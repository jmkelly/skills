...
`diagnose-crash` and `omarchy` are symlinks into `/usr/share/omarchy/default/agents/skills/`, provided by the Omarchy distribution. They live on disk but are excluded from this repo (see `.gitignore`).
